...
placerPiece(P,Plateau,NouveauPlateau):- write("A l'autre joueur de jouer."), nl, repeat, write("Choisissez la ligne"), nl, read(X), write("Choisissez la colonne"), nl, read(Y), Ind is (X-1)*4+Y, nth1(Ind,Plateau,vide()),changerElemListe(Ind,P,Plateau,NouveauPlateau).
