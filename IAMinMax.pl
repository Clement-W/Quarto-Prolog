...
creationNoeudDuNiveau(NoeudPlateau, _, ScoreNoeudPrecedent, _, _, _, _, ProfondeurMax, ProfondeurMax, NumeroMax, NumeroMax):- ScoreNoeudPrecedent is score(NoeudPlateau).

%Cas profondeur maximale :   TODO: remplacer MinOuMax par leur valeur
    % on veut maximiser le score du noeud précédent (MinOrMax == 1) et ce noeud a un score plus grand 
creationNoeudDuNiveau(NoeudPlateau, PieceTestee, ScoreNoeudPrecedent, 1, ListeCasesRestantes, IndListeCasesRestantes, IndPiece, ProfondeurMax, ProfondeurMax, Numero, NumeroMax):- ScoreNoeud is score(NoeudPlateau), ScoreNoeud > ScoreNoeudPrecedentActuellement, ScoreNoeudPrecedent is ScoreNoeud, NumeroSuivant is Numero+1, changerElemListe(IndPiece, vide(), NoeudPlateau, NoeudPlateauIntermediaire), IndSuivantListeCasesRestantes is IndListeCasesRestantes+1, nth1(IndSuivantListeCasesRestantes, ListeCasesRestantes, IndSuivantPiece), changerElemListe(IndSuivantPiece, PieceTestee, NoeudPlateauIntermediaire, NoeudPlateauSuivant), creationNoeudDuNiveau(NoeudPlateauSuivant, PieceTestee, ScoreNoeudPrecedentActuellement, 1,ListeCasesRestantes, IndSuivantListeCasesRestantes, IndSuivantPiece, ProfondeurMax, ProfondeurMax, NumeroSuivant, NumeroMax).
    % on veut maximiser le score du noeud précédent (MinOrMax == 1) et ce noeud a un score plus petit 
creationNoeudDuNiveau(NoeudPlateau, PieceTestee, ScoreNoeudPrecedent, 1, ListeCasesRestantes, IndListeCasesRestantes, IndPiece, ProfondeurMax, ProfondeurMax, Numero, NumeroMax):- ScoreNoeud is score(NoeudPlateau), ScoreNoeud < ScoreNoeudPrecedentActuellement, ScoreNoeudPrecedent is ScoreNoeudPrecedentActuellement, NumeroSuivant is Numero+1, changerElemListe(IndPiece, vide(), NoeudPlateau, NoeudPlateauIntermediaire), IndSuivantListeCasesRestantes is IndListeCasesRestantes+1, nth1(IndSuivantListeCasesRestantes, ListeCasesRestantes, IndSuivantPiece), changerElemListe(IndSuivantPiece, PieceTestee, NoeudPlateauIntermediaire, NoeudPlateauSuivant), creationNoeudDuNiveau(NoeudPlateauSuivant, PieceTestee, ScoreNoeudPrecedentActuellement, 1,ListeCasesRestantes, IndSuivantListeCasesRestantes, IndSuivantPiece, ProfondeurMax, ProfondeurMax, NumeroSuivant, NumeroMax).
    % on veut minimiser le score du noeud précédent (MinOrMax == 0) et ce noeud a un score plus petit 
creationNoeudDuNiveau(NoeudPlateau, PieceTestee, ScoreNoeudPrecedent, 0, ListeCasesRestantes, IndListeCasesRestantes, IndPiece, ProfondeurMax, ProfondeurMax, Numero, NumeroMax):- ScoreNoeud is score(NoeudPlateau), ScoreNoeud < ScoreNoeudPrecedentActuellement, ScoreNoeudPrecedent is ScoreNoeud, NumeroSuivant is Numero+1, changerElemListe(IndPiece, vide(), NoeudPlateau, NoeudPlateauIntermediaire), IndSuivantListeCasesRestantes is IndListeCasesRestantes+1, nth1(IndSuivantListeCasesRestantes, ListeCasesRestantes, IndSuivantPiece), changerElemListe(IndSuivantPiece, PieceTestee, NoeudPlateauIntermediaire, NoeudPlateauSuivant), creationNoeudDuNiveau(NoeudPlateauSuivant, PieceTestee, ScoreNoeudPrecedentActuellement, 0,ListeCasesRestantes, IndSuivantListeCasesRestantes, IndSuivantPiece, ProfondeurMax, ProfondeurMax, NumeroSuivant, NumeroMax).
